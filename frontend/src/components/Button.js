...
const Button = ({ text, to }) => {
  return (
    <Link to={to} className="relative inline-block">
      <button
        className="relative px-6 py-5 text-lg font-extrabold text-purple-600 border-2 border-purple-600 bg-pink-300 bg-transparent transition-transform transform hover:text-white"
      >
